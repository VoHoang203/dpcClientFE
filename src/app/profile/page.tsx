...
export default function ProfilePage() {
  ...
  const [user] = useState({
    ...
    dob: "15/05/1985",
    joinDate: "01/01/2010",
    officialDate: "01/07/2011",
    memberId: "DV-2024-001234",
    position: "Đảng viên chính thức",
    branch: "Chi bộ Khối Giáo dục 2",
    classification: "Hoàn thành xuất sắc nhiệm vụ",
    objectType: "Đảng viên chính thức",
    ethnicity: "Kinh",
    religion: "Không",
    education: "Đại học",
    profileNumber: "HS-2010-0456",
  });
